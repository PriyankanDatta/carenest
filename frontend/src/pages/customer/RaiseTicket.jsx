...
export default function RaiseTicket({ backPath = '/customer/tickets', detailPath = '/customer/tickets' }) {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      navigate(`${detailPath}/${data.id}`)
    } catch (e) { setErr(e.response?.data?.error || 'Failed to raise ticket') }
        ...
        <div className="card">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input className="input" placeholder="Brief summary of the issue"
            ...
            <div className="flex gap-3">
              <button type="button" onClick={() => navigate(backPath)} className="btn-secondary flex-1">Cancel</button>
